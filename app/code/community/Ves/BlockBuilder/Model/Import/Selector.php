...
*******************************************************/
class Ves_BlockBuilder_Model_Import_Selector extends Mage_Core_Model_Abstract {
	...
	public function process($filepath, $stores = array()) {
		...
		switch ($array["extension"] ) {
			...
			case "csv":
			case "txt":
				Mage::getModel('ves_blockbuilder/import_selector_csv')->process($filepath, $stores);
			break;
