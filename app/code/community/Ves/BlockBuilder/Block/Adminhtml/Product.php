...
class Ves_BlockBuilder_Block_Adminhtml_Product extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper("ves_blockbuilder")->__("Product Layout Profile Manager");
        ...
        if($this->hasData("template") && $template = $this->getData("template")) {
            ...
            $this->setTemplate('ves_blockbuilder/product/grid.phtml');
        }
    }
