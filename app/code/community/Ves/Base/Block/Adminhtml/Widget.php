 ...
 */
class Ves_Base_Block_Adminhtml_Widget extends Mage_Widget_Block_Adminhtml_Widget
{
    public function __construct()
    {
        parent::__construct();
        $is_venus_base = $this->getRequest()->getParam('ves_base');
        if($is_venus_base) {
            ...
            $this->_formScripts[] = 'wWidget = new VesWidget.Widget('
