<?php
class Ves_Base_Block_Widget_Text extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface{
	...
	public function __construct($attributes = array())
	{
		...
		if($this->hasData("template")) {
        	$my_template = $this->getData("template");
 			...
 			$my_template = "ves/base/separate_text.phtml";
 		}
	...
	protected function _toHtml(){
		...
		$this->assign('position', $this->getConfig('position'));
