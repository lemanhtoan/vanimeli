<?php
class Ves_Base_Block_Widget_Productscategory extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface{
	...
	{	
		...
		if($this->hasData("template")) {
			...
			$my_template = "ves/base/productscategory.phtml";
		}
