...
class Plumrocket_ComingSoon_Block_Adminhtml_Mode_Edit_Renderer_InputTable
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('comingsoon/adminhtml_mode_edit_renderer_inputTable_column')
                ->setData($column)
                ->setGrid($this);
        } else {
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        return $this->getLayout()->createBlock('comingsoon/adminhtml_mode_edit_renderer_field')
            ->setHtml('<div id="'. $element->getHtmlId() .'">' . $this->toHtml() . '</div>')
            ->render($element);
        ...
        /*return '
            <tr>
                ...
                <td class="value">
                    <div id="'. $element->getHtmlId() .'">' . $this->toHtml() . '</div>
                    <p class="note" id="note_'. $element->getHtmlId() .'"><span>'. $element->getNote() .'</span></p>
                </td>
            </tr>';*/
    }
