...
class Plumrocket_ComingSoon_Block_Adminhtml_Mode_Edit_Renderer_VideoGallery
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('comingsoon/adminhtml_mode_edit_renderer_videoGallery_column')
                ->setData($column)
                ->setGrid($this);
        } else {
        ...
        /*return '
            <tr>
                ...
                <td class="value" colspan="2">
                    <div id="'. $element->getHtmlId() .'"><span>'. $element->getLabel() .'</span>' . $this->toHtml() . '</div>
