 ...
 */
class Magestore_RewardPointsBehavior_Model_Actions_Pin extends Magestore_RewardPoints_Model_Action_Abstract implements Magestore_RewardPoints_Model_Action_Interface {
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpointsbehavior')->__('Receive point(s) for pin via Pinterest');
    }
    ...
    public function getPointAmount() {
        $pinter = $this->getData('action_object');
        return (int) $pinter['pinnterest_earn'];
    }
    ...
    public function prepareTransaction() {
        $pinterest = $this->getData('action_object');
