...
class Magestore_Affiliateplusprogram_Block_Adminhtml_Program_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('affiliate_type', 'select', array(
          ...
          'disabled'  => ($inStore && (isset($data['affiliate_type_in_store']) && !$data['affiliate_type_in_store'])),		//// Changed By Adam 16/10/2014
          'after_element_html' => $inStore ? '</td><td class="use-default">
			<input id="affiliate_type_default" name="affiliate_type_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['affiliate_type_in_store']) && $data['affiliate_type_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('sec_commission', 'select', array(
          ...
          'disabled'  => ($inStore && (isset($data['sec_commission_in_store']) && !$data['sec_commission_in_store'])),		// Changed By Adam 16/10/2014
          ...
          ($inStore ? '</td><td class="use-default">
			<input id="sec_commission_default" name="sec_commission_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['sec_commission_in_store']) && $data['sec_commission_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('sec_commission_type', 'select', array(
          ...
          'values'    => Mage::getSingleton('affiliateplus/system_config_source_fixedpercentage')->toOptionArray(),
          'disabled'  => ($inStore && (isset($data['sec_commission_type_in_store']) && !$data['sec_commission_type_in_store'])),		// Changed By Adam 16/10/2014
          'after_element_html' => ($inStore ? '</td><td class="use-default">
			<input id="affiliateplusprogram_sec_commission_type_inherit" name="sec_commission_type_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['sec_commission_type_in_store']) && $data['sec_commission_type_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('secondary_commission', 'text', array(
          ...
          'disabled'  => ($inStore && (isset($data['secondary_commission_in_store']) && !$data['secondary_commission_in_store'])),		// Changed By Adam 16/10/2014
          'after_element_html' => ($inStore ? '</td><td class="use-default">
			<input id="affiliateplusprogram_secondary_commission_inherit" name="secondary_commission_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['secondary_commission_in_store']) && $data['secondary_commission_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('sec_discount', 'select', array(
          ...
          'name'      => 'sec_discount',
          'values'    => Mage::getSingleton('adminhtml/system_config_source_yesno')->toOptionArray(),
          'disabled'  => ($inStore && (isset($data['sec_discount_in_store']) && !$data['sec_discount_in_store'])),		// Changed By Adam 16/10/2014
          'after_element_html' => '<p class="note">' . Mage::helper('affiliateplusprogram')->__('Select "No" to apply above discount for all orders') . '</p>' .
          ($inStore ? '</td><td class="use-default">
			<input id="affiliateplusprogram_sec_discount_inherit" name="sec_discount_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['sec_discount_in_store']) && $data['sec_discount_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('sec_discount_type', 'select', array(
          ...
          'values'    => Mage::getSingleton('affiliateplus/system_config_source_discounttype')->toOptionArray(),
          'disabled'  => ($inStore && (isset($data['sec_discount_type_in_store']) && !$data['sec_discount_type_in_store'])),		// Changed By Adam 16/10/2014
          'after_element_html' => ($inStore ? '</td><td class="use-default">
			<input id="affiliateplusprogram_sec_discount_type_inherit" name="sec_discount_type_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['sec_discount_type_in_store']) && $data['sec_discount_type_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('secondary_discount', 'text', array(
          ...
          'disabled'  => ($inStore && (isset($data['secondary_discount_in_store']) && !$data['secondary_discount_in_store'])),		// Changed By Adam 16/10/2014
          'after_element_html' => ($inStore ? '</td><td class="use-default">
			<input id="affiliateplusprogram_secondary_discount_inherit" name="secondary_discount_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['secondary_discount_in_store']) && $data['secondary_discount_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
      ...
      $fieldset->addField('customer_group_ids', 'multiselect', array(
          ...
          'disabled'  => ($inStore && (isset($data['customer_group_ids_in_store']) && !$data['customer_group_ids_in_store'])),		// Changed By Adam 16/10/2014
          ...
          ($inStore ? '</td><td class="use-default">
			<input id="customer_group_ids_default" name="customer_group_ids_default" type="checkbox" value="1" class="checkbox config-inherit" '.((isset($data['customer_group_ids_in_store']) && $data['customer_group_ids_in_store']) ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
