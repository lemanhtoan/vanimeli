...
/**
 * Rewardpoints Report Spent Grid Block
 * 
 * @category    Magestore
 * @package     Magestore_RewardPointsReport
 * @author      Magestore Developer
 */
class Magestore_RewardPointsReport_Block_Adminhtml_Spent_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('spentsreportGrid');
     ...
     * 
     * @return Magestore_RewardPointsReport_Block_Adminhtml_Spent_Grid
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter('order_id', array('notnull' => true))
            ...
            ->columns(array(
                ...
                'spent_points'  => '-SUM(IF(point_amount < 0, point_amount, 0))',
                'order_id'      => 'order_id',
