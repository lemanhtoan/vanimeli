 ...
 */
class Magestore_RewardPointsReferFriends_Block_Adminhtml_Couponcode extends Mage_Adminhtml_Block_Widget_Grid_Container {

    public function __construct() {
        $this->_controller = 'adminhtml_couponcode';
        $this->_blockGroup = 'rewardpointsreferfriends';
        $this->_headerText = Mage::helper('rewardpointsreferfriends')->__('Coupon Code Management');
