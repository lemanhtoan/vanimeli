 ...
 */
class Magestore_Affiliateplus_Adminhtml_Affiliateplus_BannerController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
        ...
        // Changed By Adam 04/05/2015: Notice: Undefined variable: storeId  in app/code/local/Magestore/Affiliateplus/controllers/Adminhtml/BannerController.php on line 127
        $storeId = $this->getRequest()->getParam('store');
