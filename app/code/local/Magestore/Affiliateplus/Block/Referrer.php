...
//                            ->addFieldToFilter('date(created_time)',$date)            // Changed By Adam 29/10/2015: Fix issue of SUPEE 6788 - in Magento 1.9.2.2
             ...
             */
            Mage::dispatchEvent('affiliateplus_referrer_sales_collection', array(
                    'collection' => $dateCollection,
            ));
            
            $cond = 'SUM(commission)';
            if (Mage::helper('core')->isModuleEnabled('Magestore_Affiliatepluslevel') && Mage::helper('affiliatepluslevel')->isPluginEnabled()) {
