...
class Magestore_Affiliateplus_Block_Adminhtml_Banner_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('source_file', 'file', array(
            ...
            'name' => 'source_file',
            'required' => $isRequired,
            'note' => $this->__('Supported format: .jpeg, .jpg, .png, .gif, .swf.'),
        ));
        ...
        $fieldset->addField('height', 'text', array(
            ...
            'required' => true,
            'name' => 'height',
            'note' => 'Specify the size of the banner showed for better display.',
        ));

        $fieldset->addField('link', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Link'),
            'note' => 'The target URL from this banner is used for redirection.',
            'name' => 'link',
        ));
        ...
        $fieldset->addField('rel_nofollow', 'select', array(
            ...
            'name' => 'rel_nofollow',
            'note' => 'Put the rel="nofollow" attribute on the link.',
