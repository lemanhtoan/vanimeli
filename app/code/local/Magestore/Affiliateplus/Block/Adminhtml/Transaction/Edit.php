...
class Magestore_Affiliateplus_Block_Adminhtml_Transaction_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('affiliateplus')->__('Save Transaction'));
        $this->_updateButton('delete', 'label', Mage::helper('affiliateplus')->__('Cancel Transaction'));
