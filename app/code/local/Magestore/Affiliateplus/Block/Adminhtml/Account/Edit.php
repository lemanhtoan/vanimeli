...
class Magestore_Affiliateplus_Block_Adminhtml_Account_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        if ($data && $data['status'] == 1) {
            ...
            $paymentUrl = $this->getUrl('adminhtml/affiliateplus_payment/new', array(
        ...
        $this->_formScripts[] = "
            ...
            function changeCommissionBy(inputData){
                var valueInput = inputData.value;
                var inputDisplay = document.getElementById('customize_commission_proportion');
                var elementParent = inputDisplay.parentElement.parentElement;
                if (valueInput == '1'){
            ...
            window.onload = function() {
                var inputData = document.getElementById('customize_commission_by');
                if (inputData)
                    changeCommissionBy(inputData);
            };
        ";
    }
