 ...
 */
class Magestore_Affiliateplusstatistic_Adminhtml_Affiliateplusstatistic_ReportController extends Mage_Adminhtml_Controller_Action {
    ...
    public function affiliatesAction() {
        ...
        $this->_initAction()
                ->_title($this->__('Affiliate Account Report'))
