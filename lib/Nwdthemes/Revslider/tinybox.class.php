...
class RevSliderTinyBox {
    ...
    public static function add_tinymce_editor(){
        ...
        Mage::helper('nwdrevslider/framework')->add_action('in_admin_footer', array('RevSliderTinyBox', 'add_tiny_mce_shortcode_dialog'));
    ...
    public static function visual_composer_include(){
        ...
        if(Mage::helper('nwdrevslider/framework')->is_user_logged_in()){
            ...
            if('vc_inline' === vc_action() || Mage::helper('nwdrevslider/framework')->is_admin()){
                Mage::helper('nwdrevslider/framework')->add_action( 'init', array('RevSliderTinyBox', 'add_to_VC' ));
            }
        }
	}
    ...
    public static function add_to_VC() {
        ...
        //Mage::helper('nwdrevslider/framework')->wp_enqueue_script('revslider-admin-script', Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'admin/assets/js/admin.js', array('jquery'), RevSliderGlobals::SLIDER_REVISION );
        Mage::helper('nwdrevslider/framework')->wp_enqueue_script('wpdialogs', 'jquery-ui-sortable', 'jquery-ui-dialog');
        Mage::helper('nwdrevslider/framework')->wp_enqueue_style('wp-jquery-ui-dialog');
        ...
        vc_map( array(
            ...
            'admin_enqueue_js' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'admin/assets/js/vc.js',
            'front_enqueue_js' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'admin/assets/js/vc.js',
            'params' => array(
                array(
    ...
    public static function add_tinymce_shortcode_editor_plugin($plugin_array){
        ...
        $plugin_array['revslider_sc_button'] = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'admin/assets/js/tinymce-shortcode-script.js';
                                    ...
                                    if(!empty($slides)){
                                        ...
                                        foreach($slides as $slide){
                                            ...
                                            if($bgt == 'image' || $bgt == 'streamvimeo' || $bgt == 'streamyoutube' || $bgt == 'streaminstagram'){
                                                switch($type){
                                                    case 'posts':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/post.png';
                                                    break;
                                                    case 'woocommerce':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/wc.png';
                                                    break;
                                                    case 'facebook':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/fb.png';
                                                    break;
                                                    case 'twitter':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/tw.png';
                                                    break;
                                                    case 'instagram':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/ig.png';
                                                    break;
                                                    case 'flickr':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/fr.png';
                                                    break;
                                                    case 'youtube':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/yt.png';
                                                    break;
                                                    case 'vimeo':
                                                        $urlImageForView = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/sources/vm.png';
                                                    break;
                                                }
                                            }
